...
Once the plan is approved, I will act as your bridge to the Implementation Engineer. Give me a prompt instructing the Implementation Engineer to create a feature branch and execute **Step 1 only** of the plan — nothing further. 
...
- *Reminder:* Always briefly remind the Implementation Engineer of the overall approved plan and highlight exactly which step number we are currently executing.
